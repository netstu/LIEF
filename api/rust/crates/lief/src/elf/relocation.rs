...
impl From<u32> for Type {
    fn from(value: u32) -> Self {
        match value {
            ...
            0x5800003e => Type::SYSZ_PC12DBL,
            0x5800003f => Type::SYSZ_PLT12DBL,
            0x58000040 => Type::SYSZ_PC24DBL,
            0x58000041 => Type::SYSZ_PLT24DBL,
            ...
            0x70000000 => Type::SH_NONE,
            0x70000001 => Type::SH_DIR32,
            0x70000002 => Type::SH_REL32,
            0x70000003 => Type::SH_DIR8WPN,
            0x70000004 => Type::SH_IND12W,
            0x70000005 => Type::SH_DIR8WPL,
            0x70000006 => Type::SH_DIR8WPZ,
            0x70000007 => Type::SH_DIR8BP,
            0x70000008 => Type::SH_DIR8W,
            0x70000009 => Type::SH_DIR8L,
            0x7000000a => Type::SH_LOOP_START,
            0x7000000b => Type::SH_LOOP_END,
            0x70000016 => Type::SH_GNU_VTINHERIT,
            0x70000017 => Type::SH_GNU_VTENTRY,
            0x70000018 => Type::SH_SWITCH8,
            0x70000019 => Type::SH_SWITCH16,
            0x7000001a => Type::SH_SWITCH32,
            0x7000001b => Type::SH_USES,
            0x7000001c => Type::SH_COUNT,
            0x7000001d => Type::SH_ALIGN,
            0x7000001e => Type::SH_CODE,
            0x7000001f => Type::SH_DATA,
            0x70000020 => Type::SH_LABEL,
            0x70000021 => Type::SH_DIR16,
            0x70000022 => Type::SH_DIR8,
            0x70000023 => Type::SH_DIR8UL,
            0x70000024 => Type::SH_DIR8UW,
            0x70000025 => Type::SH_DIR8U,
            0x70000026 => Type::SH_DIR8SW,
            0x70000027 => Type::SH_DIR8S,
            0x70000028 => Type::SH_DIR4UL,
            0x70000029 => Type::SH_DIR4UW,
            0x7000002a => Type::SH_DIR4U,
            0x7000002b => Type::SH_PSHA,
            0x7000002c => Type::SH_PSHL,
            0x7000002d => Type::SH_DIR5U,
            0x7000002e => Type::SH_DIR6U,
            0x7000002f => Type::SH_DIR6S,
            0x70000030 => Type::SH_DIR10S,
            0x70000031 => Type::SH_DIR10SW,
            0x70000032 => Type::SH_DIR10SL,
            0x70000033 => Type::SH_DIR10SQ,
            0x70000035 => Type::SH_DIR16S,
            0x70000090 => Type::SH_TLS_GD_32,
            0x70000091 => Type::SH_TLS_LD_32,
            0x70000092 => Type::SH_TLS_LDO_32,
            0x70000093 => Type::SH_TLS_IE_32,
            0x70000094 => Type::SH_TLS_LE_32,
            0x70000095 => Type::SH_TLS_DTPMOD32,
            0x70000096 => Type::SH_TLS_DTPOFF32,
            0x70000097 => Type::SH_TLS_TPOFF32,
            0x700000a0 => Type::SH_GOT32,
            0x700000a1 => Type::SH_PLT32,
            0x700000a2 => Type::SH_COPY,
            0x700000a3 => Type::SH_GLOB_DAT,
            0x700000a4 => Type::SH_JMP_SLOT,
            0x700000a5 => Type::SH_RELATIVE,
            0x700000a6 => Type::SH_GOTOFF,
            0x700000a7 => Type::SH_GOTPC,
            0x700000a8 => Type::SH_GOTPLT32,
            0x700000a9 => Type::SH_GOT_LOW16,
            0x700000aa => Type::SH_GOT_MEDLOW16,
            0x700000ab => Type::SH_GOT_MEDHI16,
            0x700000ac => Type::SH_GOT_HI16,
            0x700000ad => Type::SH_GOTPLT_LOW16,
            0x700000ae => Type::SH_GOTPLT_MEDLOW16,
            0x700000af => Type::SH_GOTPLT_MEDHI16,
            0x700000b0 => Type::SH_GOTPLT_HI16,
            0x700000b1 => Type::SH_PLT_LOW16,
            0x700000b2 => Type::SH_PLT_MEDLOW16,
            0x700000b3 => Type::SH_PLT_MEDHI16,
            0x700000b4 => Type::SH_PLT_HI16,
            0x700000b5 => Type::SH_GOTOFF_LOW16,
            0x700000b6 => Type::SH_GOTOFF_MEDLOW16,
            0x700000b7 => Type::SH_GOTOFF_MEDHI16,
            0x700000b8 => Type::SH_GOTOFF_HI16,
            0x700000b9 => Type::SH_GOTPC_LOW16,
            0x700000ba => Type::SH_GOTPC_MEDLOW16,
            0x700000bb => Type::SH_GOTPC_MEDHI16,
            0x700000bc => Type::SH_GOTPC_HI16,
            0x700000bd => Type::SH_GOT10BY4,
            0x700000be => Type::SH_GOTPLT10BY4,
            0x700000bf => Type::SH_GOT10BY8,
            0x700000c0 => Type::SH_GOTPLT10BY8,
            0x700000c1 => Type::SH_COPY64,
            0x700000c2 => Type::SH_GLOB_DAT64,
            0x700000c3 => Type::SH_JMP_SLOT64,
            0x700000c4 => Type::SH_RELATIVE64,
            0x700000c9 => Type::SH_GOT20,
            0x700000ca => Type::SH_GOTOFF20,
            0x700000cb => Type::SH_GOTFUNCDESC,
            0x700000cc => Type::SH_GOTFUNCDESC20,
            0x700000cd => Type::SH_GOTOFFFUNCDESC,
            0x700000ce => Type::SH_GOTOFFFUNCDESC20,
            0x700000cf => Type::SH_FUNCDESC,
            0x700000d0 => Type::SH_FUNCDESC_VALUE,
            0x700000f2 => Type::SH_SHMEDIA_CODE,
            0x700000f3 => Type::SH_PT_16,
            0x700000f4 => Type::SH_IMMS16,
            0x700000f5 => Type::SH_IMMU16,
            0x700000f6 => Type::SH_IMM_LOW16,
            0x700000f7 => Type::SH_IMM_LOW16_PCREL,
            0x700000f8 => Type::SH_IMM_MEDLOW16,
            0x700000f9 => Type::SH_IMM_MEDLOW16_PCREL,
            0x700000fa => Type::SH_IMM_MEDHI16,
            0x700000fb => Type::SH_IMM_MEDHI16_PCREL,
            0x700000fc => Type::SH_IMM_HI16,
            0x700000fd => Type::SH_IMM_HI16_PCREL,
...
impl From<Type> for u32 {
    fn from(value: Type) -> u32 {
        match value {
            ...
            Type::SYSZ_PC12DBL => 0x5800003e,
            Type::SYSZ_PLT12DBL => 0x5800003f,
            Type::SYSZ_PC24DBL => 0x58000040,
            Type::SYSZ_PLT24DBL => 0x58000041,
            ...
            Type::SH_NONE => 0x70000000,
            Type::SH_DIR32 => 0x70000001,
            Type::SH_REL32 => 0x70000002,
            Type::SH_DIR8WPN => 0x70000003,
            Type::SH_IND12W => 0x70000004,
            Type::SH_DIR8WPL => 0x70000005,
            Type::SH_DIR8WPZ => 0x70000006,
            Type::SH_DIR8BP => 0x70000007,
            Type::SH_DIR8W => 0x70000008,
            Type::SH_DIR8L => 0x70000009,
            Type::SH_LOOP_START => 0x7000000a,
            Type::SH_LOOP_END => 0x7000000b,
            Type::SH_GNU_VTINHERIT => 0x70000016,
            Type::SH_GNU_VTENTRY => 0x70000017,
            Type::SH_SWITCH8 => 0x70000018,
            Type::SH_SWITCH16 => 0x70000019,
            Type::SH_SWITCH32 => 0x7000001a,
            Type::SH_USES => 0x7000001b,
            Type::SH_COUNT => 0x7000001c,
            Type::SH_ALIGN => 0x7000001d,
            Type::SH_CODE => 0x7000001e,
            Type::SH_DATA => 0x7000001f,
            Type::SH_LABEL => 0x70000020,
            Type::SH_DIR16 => 0x70000021,
            Type::SH_DIR8 => 0x70000022,
            Type::SH_DIR8UL => 0x70000023,
            Type::SH_DIR8UW => 0x70000024,
            Type::SH_DIR8U => 0x70000025,
            Type::SH_DIR8SW => 0x70000026,
            Type::SH_DIR8S => 0x70000027,
            Type::SH_DIR4UL => 0x70000028,
            Type::SH_DIR4UW => 0x70000029,
            Type::SH_DIR4U => 0x7000002a,
            Type::SH_PSHA => 0x7000002b,
            Type::SH_PSHL => 0x7000002c,
            Type::SH_DIR5U => 0x7000002d,
            Type::SH_DIR6U => 0x7000002e,
            Type::SH_DIR6S => 0x7000002f,
            Type::SH_DIR10S => 0x70000030,
            Type::SH_DIR10SW => 0x70000031,
            Type::SH_DIR10SL => 0x70000032,
            Type::SH_DIR10SQ => 0x70000033,
            Type::SH_DIR16S => 0x70000035,
            Type::SH_TLS_GD_32 => 0x70000090,
            Type::SH_TLS_LD_32 => 0x70000091,
            Type::SH_TLS_LDO_32 => 0x70000092,
            Type::SH_TLS_IE_32 => 0x70000093,
            Type::SH_TLS_LE_32 => 0x70000094,
            Type::SH_TLS_DTPMOD32 => 0x70000095,
            Type::SH_TLS_DTPOFF32 => 0x70000096,
            Type::SH_TLS_TPOFF32 => 0x70000097,
            Type::SH_GOT32 => 0x700000a0,
            Type::SH_PLT32 => 0x700000a1,
            Type::SH_COPY => 0x700000a2,
            Type::SH_GLOB_DAT => 0x700000a3,
            Type::SH_JMP_SLOT => 0x700000a4,
            Type::SH_RELATIVE => 0x700000a5,
            Type::SH_GOTOFF => 0x700000a6,
            Type::SH_GOTPC => 0x700000a7,
            Type::SH_GOTPLT32 => 0x700000a8,
            Type::SH_GOT_LOW16 => 0x700000a9,
            Type::SH_GOT_MEDLOW16 => 0x700000aa,
            Type::SH_GOT_MEDHI16 => 0x700000ab,
            Type::SH_GOT_HI16 => 0x700000ac,
            Type::SH_GOTPLT_LOW16 => 0x700000ad,
            Type::SH_GOTPLT_MEDLOW16 => 0x700000ae,
            Type::SH_GOTPLT_MEDHI16 => 0x700000af,
            Type::SH_GOTPLT_HI16 => 0x700000b0,
            Type::SH_PLT_LOW16 => 0x700000b1,
            Type::SH_PLT_MEDLOW16 => 0x700000b2,
            Type::SH_PLT_MEDHI16 => 0x700000b3,
            Type::SH_PLT_HI16 => 0x700000b4,
            Type::SH_GOTOFF_LOW16 => 0x700000b5,
            Type::SH_GOTOFF_MEDLOW16 => 0x700000b6,
            Type::SH_GOTOFF_MEDHI16 => 0x700000b7,
            Type::SH_GOTOFF_HI16 => 0x700000b8,
            Type::SH_GOTPC_LOW16 => 0x700000b9,
            Type::SH_GOTPC_MEDLOW16 => 0x700000ba,
            Type::SH_GOTPC_MEDHI16 => 0x700000bb,
            Type::SH_GOTPC_HI16 => 0x700000bc,
            Type::SH_GOT10BY4 => 0x700000bd,
            Type::SH_GOTPLT10BY4 => 0x700000be,
            Type::SH_GOT10BY8 => 0x700000bf,
            Type::SH_GOTPLT10BY8 => 0x700000c0,
            Type::SH_COPY64 => 0x700000c1,
            Type::SH_GLOB_DAT64 => 0x700000c2,
            Type::SH_JMP_SLOT64 => 0x700000c3,
            Type::SH_RELATIVE64 => 0x700000c4,
            Type::SH_GOT20 => 0x700000c9,
            Type::SH_GOTOFF20 => 0x700000ca,
            Type::SH_GOTFUNCDESC => 0x700000cb,
            Type::SH_GOTFUNCDESC20 => 0x700000cc,
            Type::SH_GOTOFFFUNCDESC => 0x700000cd,
            Type::SH_GOTOFFFUNCDESC20 => 0x700000ce,
            Type::SH_FUNCDESC => 0x700000cf,
            Type::SH_FUNCDESC_VALUE => 0x700000d0,
            Type::SH_SHMEDIA_CODE => 0x700000f2,
            Type::SH_PT_16 => 0x700000f3,
            Type::SH_IMMS16 => 0x700000f4,
            Type::SH_IMMU16 => 0x700000f5,
            Type::SH_IMM_LOW16 => 0x700000f6,
            Type::SH_IMM_LOW16_PCREL => 0x700000f7,
            Type::SH_IMM_MEDLOW16 => 0x700000f8,
            Type::SH_IMM_MEDLOW16_PCREL => 0x700000f9,
            Type::SH_IMM_MEDHI16 => 0x700000fa,
            Type::SH_IMM_MEDHI16_PCREL => 0x700000fb,
            Type::SH_IMM_HI16 => 0x700000fc,
            Type::SH_IMM_HI16_PCREL => 0x700000fd,
            Type::SH_64 => 0x700000fe,
            Type::SH_64_PCREL => 0x700000ff,
